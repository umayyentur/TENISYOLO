...
class MiniCourt():
    def __init__(self,frame):
        ...
        self.set_canva_background_box_position(frame)
    ...
    def set_canva_background_box_position(self,frame):
        frame = frame.copy()
    ...
    def get_width_of_mini_count(self):
        return self.drawing_rectangle_width
    
    def get_court_drawings_key_points(self):
